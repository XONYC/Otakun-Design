function rpthumbnt(json) {
 ...
 for (var i = 0; i < numposts; i++) {
  ...
  try {
   ...
   if ((a != -1) && (b != -1) && (c != -1) && (d != "")) {
    thumburl = d
   } else thumburl = 'https://4.bp.blogspot.com/-XPJEdEC-gQM/WDOthRNTwNI/AAAAAAAABYw/DCk0N3n6MYwR3lFLrC41bmMsRNeZxnR5ACPcB/s1600/noimagethumb.gif'
  }
  document.write('<li class="news-title clearfix">');
  document.write('<a href="https://waifu-bt.blogspot.co.id/" target="_blank"><img src="' + thumburl + '"/></a>');
